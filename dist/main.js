...
var cancelAllFuturesOrders = function (symbol) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_1 = _a.sent();
                console.error("Error cancelling futures orders for ".concat(symbol, ":"), error_1);
                return [3 /*break*/, 3];
...
var getLastClosedFuturesProfits = function (n) { return __awaiter(void 0, void 0, void 0, function () {
    var trades, aggregatedTrades, currentSymbol, currentIncome, _i, trades_1, trade, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
            ...
            case 2:
                error_2 = _a.sent();
                console.error('Error fetching closed futures positions:', error_2);
                throw error_2;
            case 3: return [2 /*return*/];
        }
    });
